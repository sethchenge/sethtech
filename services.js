...
// ===== SIMPLE SCROLL REVEAL (Standard) =====
// This triggers CSS animations when elements scroll into view
...
document.querySelectorAll('.scroll-reveal, .service-card, .process-step, .tech-item').forEach(el => {
